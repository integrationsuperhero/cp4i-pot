...
- [2. Integration Servers](#integration_servers)
  ...
  * [2.2 Putting integration servers to work!](#putting_integration_servers_to_work)
...
The purpose of this LAB is to show the configuration needed to distribute workloads using IBM App Connect Enterprise Callable Flows.
...
The ability to create a local integration server from the Integration Toolkit was introduced in fix pack 8 of IBM App Connect Enterprise. In the next section you will create a local integration server using this feature. The follow diagram shows what you will set up on your local integration server.
...
[https://cpd-cp4i.apps.chopper.coc-ibm.com/](https://cpd-cp4i.apps.chopper.coc-ibm.com/)

Note: This is the url for the cluster you are assigned for this PoT.   In this instance we are using the **chopper cluster**.
...
In this example we are using the **chopper** cluster and **chopper9 userid**

[http://is-toolkit-basic-http-chopper9.apps.chopper.coc-ibm.com/PING_Basic](http://is-toolkit-basic-http-chopper9.apps.chopper.coc-ibm.com/PING_Basic)
