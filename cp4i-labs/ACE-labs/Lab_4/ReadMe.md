...
**Note: For this lab we will need to add the api-gateway info into the yaml before importing into APIC.   This will be corrected in the next update.  Edit your salesforce yaml file and should look likt the screen shot below**
