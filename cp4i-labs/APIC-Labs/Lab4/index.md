**APIC Lab 4 - Use Lifecycle Controls to Version your API**
...
4.  Title this product [[Inventory Product]] and
    click [[Next]]
...
2.  Select **[Products]** tab, click the **[⋮]** button next to your
    **[Inventory Product]** and **[Stage]** it.
...
1. Click **[Manage]** from the menu on the left and click on
  your **[Sandbox]** catalog tile.

2. The **[Products tab]** will list all of
  the API Products that this Catalog is currently managing.

3. Make sure your newly created API Product **[Inventory Product]** is in
...
5. Select the **[Inventory Product]** product, as this is the one
...
  Both of our Products have plans called**[ Default
  ...
  subscribers from the Inventory API's default plan to the
...
3.  Notice that the old **[Inventory
    ...
    It has been replaced by your new **[Inventory Product]** product.

4.  Click on the **[ Inventory Product]**. 
...
6.  Click on the **[inventory 2.0.0]** API from
    the palette menu on the left.

7.  Select the **[GET /Items]** operation
    and click on the **[Try It ]** tab at
...
You completed the APIC Lab 4 - Use Lifecycle Controls to Version
...
Continue the APIC Labs. Go to[ APIC Lab 5 - Advanced API
Assembly](https://github.ibm.com/americas-integration/cp4i-pot/tree/master/cp4i-labs/APIC-Labs/Lab5) to
